...
const getSecurityAlerts = __nccwpck_require__(88)
const owasp10 = __nccwpck_require__(3773)
const mapRisksToAlerts = __nccwpck_require__(2930)
...
async function run() {
  try {
    ...
    // Set output
    const absolutePath = __nccwpck_require__.ab + "mapping.csv"
    core.setOutput('mappingsFilepath', __nccwpck_require__.ab + "mapping.csv")
...
// Imports
const { constants } = __nccwpck_require__(4300)
